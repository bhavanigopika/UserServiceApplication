...
Actually, in spring security itself will do it without manual but, it needd OAuth2. Spring Authorization server, add dependency then work.
...
*/
/*
Now, Let's implement few API and show how to use spring security and remove all the savings of token and authorize our API's.
